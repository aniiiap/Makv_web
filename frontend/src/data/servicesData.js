// Static services data - loaded instantly without API call
export const servicesData = {
  ...
  internationalTaxation: {
    title: 'International Taxation',
    description: 'Practical international tax and transfer pricing support. US work: OYO, Kentucky, California. Australia: Melbourne, Perth, Adelaide. International work: Alberta, India and other key locations.',
    services: [
      {
        id: 1,
      ...
      },
      {
        ...
        description: 'Comprehensive transfer pricing documentation, benchmarking, and compliance services for intercompany transactions',
      },
      {
        id: 3,
        title: 'Tax Treaty Benefits',
        description: 'Optimizing tax treaty benefits and Double Tax Avoidance Agreements (DTAA) to minimize tax liability',
      },
      {
        id: 4,
      ...
      },
      {
        ...
        description: 'Base Erosion and Profit Shifting (BEPS) compliance and reporting requirements for multinational enterprises operating across these international locations',
      },
      {
        id: 10,
      ...
      {
        id: 11,
        title: 'International Tax Dispute Resolution',
        description: 'Representation and assistance in resolving international tax disputes and advance pricing agreements (APAs) across these key international locations',
      },
    ],
  },
