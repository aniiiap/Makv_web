      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-white mb-4 font-medium drop-shadow-lg"
          >
          ...
          <motion.p
            ...
            className="text-lg text-white/90 mb-12 max-w-3xl mx-auto drop-shadow-md"
          >
          ...
          >
            ...
            <Link to="/services">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-white text-primary-600 rounded-lg font-semibold text-lg border-2 border-primary-600 hover:bg-primary-50 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                Our Services
              </motion.button>
            </Link>
